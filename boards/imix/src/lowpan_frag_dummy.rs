...
pub const SRC_ADDR: IPAddr = IPAddr([0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf8, 0x4c, 0x1a, 0xc7, 0x7a, 0x05, 0x48, 0xee]);
pub const SRC_MAC_ADDR: MacAddress = MacAddress::Long([0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16,
                                                       0x17]);

// DEST: RASPBERRY PI LINK LOCAL, GOOGLE IP
pub const DST_ADDR: IPAddr = IPAddr([0x20, 0x01, 0x48, 0x60, 0x48, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x88, 0x88]);
pub const DST_MAC_ADDR: MacAddress = MacAddress::Long([0x3a, 0x51, 0x3e, 0xb6, 0xec, 0x96, 0xc6, 0xaa]);
