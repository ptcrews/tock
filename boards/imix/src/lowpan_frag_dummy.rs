...
pub const DST_ADDR: IPAddr = IPAddr([0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xd8, 0xa9,
                                     0xfb, 0x6b, 0x29, 0xd0, 0x2c, 0xf6]);
pub const SRC_MAC_ADDR: MacAddress = MacAddress::Long([0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16,
                                                       0x17]);
pub const DST_MAC_ADDR: MacAddress = MacAddress::Long([0xda, 0xa9, 0xfb, 0x6b, 0x02, 0x9d, 0x2c,
                                                       0xf6]);
